...
def display(size, text, pos):
    ...
    textRect.center = pos
    level2_display.blit(text, textRect)
...
block_x = [51, 51, 51, 51, 101, 151, 201, 251, 301, 351, 401, 401, 401, 401]
block_y = [251, 201, 151, 101, 51, 51, 51, 51, 51, 51, 101, 151, 201, 251]
...
while True:
    level2_display = pygame.display.set_mode((500, 650))
    level2_display.fill((0, 150, 255))
    pygame.draw.line(level2_display, (200, 200, 200), (0, 500), (500, 500), 5)
    pygame.draw.rect(level2_display, (235, 109, 0), pygame.Rect(plank_x, plank_y, 100, 20))
    ball = pygame.draw.circle(level2_display, (255, 0, 0), (ball_x, ball_y), 25)
    ...
    if pause and ball_speed_y != 0:
        for i in range(len(block_x)):
            j = len(block_x) - i - 1
            square = pygame.draw.rect(level2_display, (0, 0, 0), pygame.Rect(block_x[j], block_y[j], 48, 48))
        display(100, "PAUSED", (250, 255))
        display(30, "(CONTINUE PRESS 'P')", (250, 325))
        replay = pygame.draw.rect(level2_display, (100, 100, 100), pygame.Rect(10, 370, 230, 70))
        home = pygame.draw.rect(level2_display, (100, 100, 100), pygame.Rect(260, 370, 230, 70))
        finish()
    ...
    if ball_y > 675:
        ...
        pygame.draw.rect(level2_display, (0, 150, 255), pygame.Rect(0, 610, 260, 40))
        replay = pygame.draw.rect(level2_display, (100, 100, 100), pygame.Rect(10, 370, 230, 70))
        home = pygame.draw.rect(level2_display, (100, 100, 100), pygame.Rect(260, 370, 230, 70))
        finish()
    ...
    if len(block_x) == 0:
        ...
        pygame.draw.rect(level2_display, (235, 109, 0), pygame.Rect(plank_x, plank_y, 100, 20))
        ball = pygame.draw.circle(level2_display, (255, 0, 0), (ball_x, ball_y), 25)
        display(50, "LEVEL 2 COMPLETE", (250, 325))
        next_stage_button = pygame.draw.rect(level2_display, (100, 100, 100), pygame.Rect(100, 370, 300, 70))
        main_menu = pygame.draw.rect(level2_display, (100, 100, 100), pygame.Rect(100, 470, 300, 70))
        next_stage()
        pygame.display.update()
